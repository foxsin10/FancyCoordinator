...
public struct IfLet<Parent: CoordinatorRepresentable, Child: CoordinatorRepresentable>: CoordinatorRepresentable where Parent.Scene == Child.Scene {
  ...
  public func coordinate(
    to route: Parent.Route,
    withContext context: Parent.Context
  ) -> Child.Scene? {
...
public extension CoordinatorRepresentable {
  ...
  >(
    ...
    line: UInt = #line
  ) -> some CoordinatorRepresentable<Route, Scene, Context> where Scene == C.Scene, Context == C.Context {
